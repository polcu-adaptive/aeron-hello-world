...
import com.weareadaptive.chatServer.task3.agent.AgentState;
import com.weareadaptive.chatServer.task3.agent.RecordingInfo;
...
public class WebGatewayAgent implements Agent
{
    ...
    public void registerWebSocket(final ServerWebSocket webSocket)
    {
        ...
        if (recordingInfo.getRecordingId() != Long.MIN_VALUE)
        {
            ...
            final int replayStreamId = new Random().nextInt(10000);
